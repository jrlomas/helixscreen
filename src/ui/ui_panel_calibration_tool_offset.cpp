...
void ToolOffsetCalibrationPanel::on_deactivating(DeactivateReason reason) {
    ...
    // the run and save callbacks ride on object_lifetime_ instead.
...
void ToolOffsetCalibrationPanel::begin_run() {
    ...
    api->execute_gcode(
        gcode,
        object_lifetime_.bg_cb("ToolOffsetCal::done", [this]() { on_run_finished(true, ""); }),
        object_lifetime_.bg_cb("ToolOffsetCal::error",
...
void ToolOffsetCalibrationPanel::send_save() {
    ...
    helix::zoffset::save_dirty_offsets(
        ...
        object_lifetime_.bg_cb("ToolOffsetCal::save_failed",
