...
static std::vector<PanelWidgetDef> s_widget_defs = {
    ...
    {"shutdown",         TR_NOOP("Shutdown/Reboot"),   "power",            TR_NOOP("Shut down or restart the host"),  "platform_host_power_supported", "Not available on Android",                               CAT_SYSTEM,   false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    {"lock",             TR_NOOP("Lock Screen"),       "lock",             TR_NOOP("Lock the screen with your PIN"),      nullptr,              nullptr,                               CAT_SYSTEM,   false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    {"power_device",     TR_NOOP("Power"),            "power_cycle",      TR_NOOP("Switch a power device on or off"),            "power_device_count", "Requires Moonraker power device",     CAT_CONTROLS, false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, true, true, true},
    {"network",          TR_NOOP("Network"),          "wifi_strength_4",  TR_NOOP("Wi-Fi or ethernet connection status"),          nullptr,              nullptr,                               CAT_SYSTEM,   false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    {"firmware_restart", TR_NOOP("Firmware Restart"),  "refresh",          TR_NOOP("Restart Klipper without rebooting"), nullptr,              nullptr,                               CAT_SYSTEM,   false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"led",              TR_NOOP("LED Light"),         "lightbulb_outline",TR_NOOP("Turn the printer's lights on or off"),        "led_controllable",   "No LED strips detected",              CAT_CONTROLS, true,  2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    {"led_controls",     TR_NOOP("LED Controls"),      "led_strip",        TR_NOOP("Open color and brightness controls"),     "led_controllable",   "No LED strips detected",              CAT_CONTROLS, false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"fan",              TR_NOOP("Fan"),               "fan",              TR_NOOP("The speed of one fan you choose"),              nullptr,              nullptr,                               CAT_TEMP,     false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, true, true, true},
    {"temperature",      TR_NOOP("Nozzle Temperature"),"thermometer",      TR_NOOP("Set and watch the nozzle temperature"), nullptr,            nullptr,                               CAT_TEMP,     true,  2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"bed_temperature",  TR_NOOP("Bed Temperature"),   "radiator",         TR_NOOP("Set and watch the bed temperature"),    nullptr,            nullptr,                               CAT_TEMP,     true, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    {"chamber_temperature", TR_NOOP("Chamber Temperature"), "fridge_industrial", TR_NOOP("Set and watch the chamber temperature"), "printer_has_chamber", "No chamber temperature sensor detected", CAT_TEMP,     false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"thermistor",       TR_NOOP("Temperature Sensors"), "thermometer",    TR_NOOP("Readings from extra temperature sensors"), "temp_sensor_count", "No temperature sensors detected", CAT_TEMP,     false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, true, true, true},
    ...
    {"bypass",           TR_NOOP("Bypass"),           "source_branch",    TR_NOOP("Toggle external spool bypass"), "ams_supports_bypass", "Requires a filament system with bypass", CAT_FILAMENT, false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"filament",         TR_NOOP("Filament Sensor"),   "filament_alert",   TR_NOOP("Whether filament is loaded"),  "filament_sensor_count", "No filament sensor detected",      CAT_FILAMENT, true, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"macros",           TR_NOOP("Macros"),            "script_text",      TR_NOOP("Browse and run your Klipper macros"),           nullptr,              nullptr,                               CAT_CONTROLS, false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    {"motion",           TR_NOOP("Motion"),            "cursor_move",      TR_NOOP("Open motion controls for jogging"),           nullptr,              nullptr,                               CAT_CONTROLS, false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
    ...
    {"gcode_console",    TR_NOOP("GCode Console"),     "console",          TR_NOOP("Send G-code and read the replies"),    nullptr,              nullptr,                               CAT_CONTROLS, false, 2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
#if HELIX_HAS_CAMERA
...
#endif
    {"notifications",    TR_NOOP("Notifications"),     "notifications",    TR_NOOP("Alerts and messages waiting for you"),    nullptr,              nullptr,                               CAT_SYSTEM,   true,  2, 2, 1, 2, BAND_COLSPAN, BAND_COLSPAN, false, true, true},
};
// clang-format on
