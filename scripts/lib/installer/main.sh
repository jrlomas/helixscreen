...
print_k2_stock_ai_notice() {
    ...
    log_warn "  warning when it sees spaghetti - or only warns, if the printer's own"
    log_warn "  ai_control settings say not to pause. Its interval, threshold and pause"
    log_warn "  choice come from those settings (pastaTime / pastaTruth / pausePrint)."
