...
MDI_ICONS+=",0xF0132"    # checkbox-marked (filled/checked)
MDI_ICONS+=",0xF0131"    # checkbox-blank-outline (empty/unchecked)
...
MDI_ICONS+=",0xF04E1"    # swap-horizontal
...
SIZES="14 16 24 32 48 64 80 96 128"
