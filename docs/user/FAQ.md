...
- **OpenAMS** without AFC — supported through klipper_openams' own UI API. Status appears as soon as that API is installed; Load and Unload appear once its updated `OPENAMS_LOAD` / `OPENAMS_UNLOAD` macros are merged into your macro file
